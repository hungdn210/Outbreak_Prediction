...
def Run():
  for csv_file in constants.INPUT_DIR_LIST:
    ...
    evaluation_logging.Log_results_to_csv(model_name='Ensemble (mean weight)', metrics=ensemble_metrics, learned_thresholds=ensemble_learned_thresholds, K=constants.K, input_dir=csv_file, output_dir=constants.OUTPUT_DIR, Y_test=Y_test, Y_pred=ensemble_Y_pred, debug=True)
